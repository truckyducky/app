...
descriptors_data = pd.read_csv(r"/Users/trucpham/Downloads/HEAL icebreaker kg 11_04_23.csv")
...
try:
    path = '/tmp'
    net.save_graph(f'{path}/icebreaker_graph.html')
    HtmlFile = open(f'{path}/icebreaker_graph.html', 'r', encoding='utf-8')
