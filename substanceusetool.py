...
net.add_node('Node 35 - Tobacco, Alcohol, Prescription Medication, and Other Substance Use Tool [TAPS-1]',
              title = 'Tobacco, Alcohol, Prescription Medication, and Other Substance Use Tool [TAPS-1]', color = '#e07c3e')
...
"IMPOWR- Integrative Management of chronic Pain and OUD for whole Recovery",
...
"Interdisciplinary Teams to Elucidate the Mechanisms of Device-Based Pain Relief",
...
"PRECISION Human Pain- Program to Reveal and Evaluate Cells-to-gene Information that Specify Intricacies, Origins, and the Nature of Human Pain",
...
"PRISM- Pragmatic and Implementation Studies for the Management of Pain to Rescue Opioid Prescribing",
...
"RE JOIN- Restoring Joint Health and Function to Reduce Pain",
...
for item in edge_list:
    net.add_edge('Node 35 - Tobacco, Alcohol, Prescription Medication, and Other Substance Use Tool [TAPS-1]',item)
