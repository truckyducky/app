...
net.add_node('Node 32 - PROMIS Physical Function - Short Form 6b [PROMIS PF-SF6b]',
              title = 'PROMIS Physical Function - Short Form 6b [PROMIS PF-SF6b]', color = '#e07c3e')
...
"Innervation of the knee and TMJ",
"Mapping the joint-nerve interactome of the knee",
"Neural architecture of the murine and human temporomandibular joint", "Group-Based Mindfulness for Patients with Chronic Low Back Pain in the Primary Care"]


for item in edge_list:
    net.add_edge('Node 32 - PROMIS Physical Function - Short Form 6b [PROMIS PF-SF6b]', item)
