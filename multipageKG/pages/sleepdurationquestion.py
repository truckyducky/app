...
net.add_node('Node 34 - Sleep Duration Question [SD - Adult or Peds]',
              title = 'Sleep Duration Question [SD - Adult or Peds]', color = '#e07c3e')
...
for item in edge_list:
    net.add_edge('Node 34 - Sleep Duration Question [SD - Adult or Peds]',item)
