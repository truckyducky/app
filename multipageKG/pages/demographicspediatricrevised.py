...
net.add_node('Node 18 - Demographics - Pediatric, revised [Demographics-Peds Revised]',  
              title = 'Demographics - Pediatric, revised [Demographics-Peds Revised]', color = '#e07c3e')
