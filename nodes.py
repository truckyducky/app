 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a958adf0>"
      ]
     },
     "execution_count": 227,
     "metadata": {},
   ...
   "source": [
    ...
    "\n",
    "\n",
    "net.show('nodes.html',local = False)\n",
    "\n"
   ]
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a97ba1c0>"
      ]
     },
     "execution_count": 228,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a928f1f0>"
      ]
     },
     "execution_count": 229,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a97738b0>"
      ]
     },
     "execution_count": 231,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a978ae80>"
      ]
     },
     "execution_count": 232,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a9534880>"
      ]
     },
     "execution_count": 233,
     "metadata": {},
   ...
   "outputs": [
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x7f96a976eaf0>"
      ]
     },
     "execution_count": 234,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "HtmlFile = open(\"edges.html\", 'r', encoding='utf-8')\n",
